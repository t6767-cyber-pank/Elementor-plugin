...
class About_Header_Widget extends \Elementor\Widget_Base
{
    ...
    protected function _register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => __( 'Skilled photographers with a little quirk: We’re Harper Point.'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    'url' => "/wp-content/themes/harperpoint/library/img/about.png",
                ],
            ]
        );
    ...
    protected function render()
    {
        ...
        ?>
        <section class="harper-point-header left before" id="about-header">
            <div class="container">
                <div class="row">
                    <div class="col-6">
                        <div class="img-block">
