...
class Project_Right_Widget extends \Elementor\Widget_Base
{
    ...
    protected function _register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    'url' => "/wp-content/themes/harperpoint/library/img/lifestyle_2.png",
                ],
            ]
        );
                        ...
                        <div>
                            ...
                            <script type="text/javascript">
                                document.addEventListener('DOMContentLoaded', function () {
                                    document.vueInitImg('lifestyle-img-2-vue', '<?= $settings["image"]["url"] ?>', '1');
                                });
                            </script>
                        </div>
