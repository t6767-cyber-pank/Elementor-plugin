...
class Eye_Candy_Header_Widget extends \Elementor\Widget_Base
{

    public function get_name()
    {
        return 'Eye Candy - header';
    }

    public function get_title()
    {
        return __('Eye Candy - header');
    }
    ...
    protected function _register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => __( 'We take photographs<br>that make you feel something.'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    'url' => "/wp-content/themes/harperpoint/library/img/eye_candy_page.png",
                ],
            ]
        );
    ...
    protected function render()
    {
        ...
        ?>
        <section class="harper-point-header left eye-candy-header">
            <div class="container">
                <div class="row">
                    <div class="col-6">
                        <div class="img-block">
