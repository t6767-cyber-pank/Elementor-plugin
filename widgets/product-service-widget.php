...
class Product_Service_Widget extends \Elementor\Widget_Base
{
    ...
    protected function _register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => __( 'we take photos of objects and merchandise to be used in online sales, branded website and marketing content and printed publications.'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    'url' => "/wp-content/themes/harperpoint/library/img/product.png",
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::MEDIA,
                'default' => [
                    'url' => "/wp-content/themes/harperpoint/library/img/product_img1.png",
                ],
            ]
        );
    ...
    protected function render()
    {
        ...
        <section class="harper-point services-product">
            <div class="container">
                <div class="row">
                    <div class="col-12 col-lg-5 offset-lg-1 services-product-img-1 img-servicer">
                        <div class="lifestyle-img">
                            ...
                            <script type="text/javascript">
                                document.addEventListener('DOMContentLoaded', function () {
                                    document.vueInitImg('product-img-vue', '<?= $settings["image1"]["url"] ?>', '1');
                                });
                            </script>
                        </div>
                    </div>
                    ...
                    <div class=" col-12 col-lg-6 p-lg-5">
                        <div class="harper-point-title">
                            <div class="row">
                                <div class="col-6 col-lg-12">
                                    <div class="harper-point-text flex-end">
                                        <a href="<?= $settings["link"]?>">
                                            ...
                                            <script type="text/javascript">
                                                document.addEventListener('DOMContentLoaded', function () {
                                                    document.vueInitTitle('product-vue', '<?= $settings["title"]?>', '5em');
                                                });
                                            </script>
                                        </a>
                                    </div>
                                ...
                                <div class="col-6 col-lg-12 img-mb-servicer">
                                    <div data-v-3059c385="" class="img-block"><img data-v-3059c385="" data-src="<?= $settings["image2"]["url"] ?>" class="active" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" lazy="loading"></div>
                                    <script type="text/javascript">
                                        document.addEventListener('DOMContentLoaded', function () {
                                            document.vueInitImg('product-img-mb-vue', '<?= $settings["image2"]["url"] ?>', '1');
                                        });
                                    </script>
                                </div>
                            </div>
                        ...
                        <div class="harper-point-text">
                            ...
                            <script type="text/javascript">
                                document.addEventListener('DOMContentLoaded', function () {
                                    document.vueInitText('product-text-vue', '<?= $settings["content"]?>', '1.2em');
                                });
                            </script>
                        </div>
                ...
                <div class="col-10 offset-1 col-lg-8 offset-lg-4 ">
                    ...
                    <script type="text/javascript">
                        document.addEventListener('DOMContentLoaded', function () {
                            document.vueInitImg('product-img1-vue', '<?= $settings["image3"]["url"] ?>', '1');
                        });
                    </script>
                </div>
            </div>
