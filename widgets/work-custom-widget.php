...
class Work_custom_Widget extends \Elementor\Widget_Base
{

    public function get_name()
    {
        return 'Work - custom left big';
    }

    public function get_title()
    {
        return __('Work - custom left big');
    }
    ...
    protected function _register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    'url' => "/wp-content/themes/harperpoint/library/img/client_name_1.png",
                ],
            ]
        );
        ...
        <section class="client-name">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-5">
                        <div class="client-name-text-block left">
